        ...
        <section className="signup-form">
            ...
            <form method="post" encType="multipart/form-data">
              ...
              <div className="job-form">
                ...
                <br></br>
                <button type="submit" id="userJob" title="프론트엔드" className="frontend" onChange={onChangeInput}>프론트엔드</button>
                <button type="submit" id="userJob" title="백엔드" className="backend" onChange={onChangeInput}>백엔드</button>
                <button type="submit" id="userJob" title="풀스택" className="fullStack" onChange={onChangeInput}>풀스택</button>
                <button type="submit" id="userJob" title="프론트엔드" className="frontend" onChange={onChangeInput}>데이터베이스</button>
                <button type="submit" id="userJob" title="백엔드" className="backend" onChange={onChangeInput}>머신러닝</button>
                <button type="submit" id="userJob" title="풀스택" className="fullStack" onChange={onChangeInput}>모바일 앱</button>
                <button type="submit" id="userJob" title="프론트엔드" className="frontend" onChange={onChangeInput}>QA엔지니어</button>
                <button type="submit" id="userJob" title="백엔드" className="backend" onChange={onChangeInput}>시스템엔지니어</button>
                <button type="submit" id="userJob" title="풀스택" className="fullStack" onChange={onChangeInput}>보안엔지니어</button>
              </div>
